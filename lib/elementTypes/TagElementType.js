...
function TagElementType(node, key) {
  ...
  if (node.name === 'img') return _react2.default.createElement(_c_wap_module.MediaPlayer, { property: node.attribs });else return _react2.default.createElement(tagName, props, children);
}